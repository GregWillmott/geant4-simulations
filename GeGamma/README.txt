...
./GeGamma       - brings up GUI. In the GUI command bar do /control/execute runMacroVis.mac to use the macro
                  ...
                  change which GPS macro runMacroVis.mac executes. Follow up with /run/beamOn 20 to see some
                  particle histories.
...
gps_radioactive.mac - example GPS. Radioactively decaying 60Co placed at (0,0,0). Decay products will come out of the origin.
...
If you need space to define your source with random numbers / you want something more complex, go back to the particle gun instead of GPS.
