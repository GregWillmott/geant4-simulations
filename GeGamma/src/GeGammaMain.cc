...
int main(int argc, char** argv){
    ...
    G4RunManager * runManager = G4RunManagerFactory::CreateRunManager(G4RunManagerType::Default);
        ...
        G4int nThreads = 4; // Change number of threads here, I can make nThreads a command line argument if needed.
    ...
    G4HadronicParameters::Instance()->SetTimeThresholdForRadioactiveDecay(1.0e60*CLHEP::year);
