...
class DetectorConstruction : public G4VUserDetectorConstruction
{
	public:
			...
			G4VPhysicalVolume* fSiliconNSidePV = nullptr; // Pointer which will point to the Silicon Phys Volume.
			G4VPhysicalVolume* fSiliconPSidePV = nullptr; // Pointer which will point to the Silicon Phys Volume.
